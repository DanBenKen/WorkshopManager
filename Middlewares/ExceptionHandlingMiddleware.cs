    ...
    public class ExceptionHandlingMiddleware
    {
        ...
        private async Task HandleExceptionAsync(HttpContext context, Exception exception)
        {
            var statusCode = exception switch
            {
                ...
                WorkerUpdateNullException => StatusCodes.Status404NotFound,
                SupplyNotFoundException => StatusCodes.Status404NotFound,
                SupplyGetNullException => StatusCodes.Status404NotFound,
                SupplyCreateNullException => StatusCodes.Status404NotFound,
                SupplyUpdateNullException => StatusCodes.Status404NotFound,
